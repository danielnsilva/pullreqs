...
#{File.basename($0)} owner repo token
  ...
  def process_pull_request(pr, lang)
    ...
    # Create line for a pull request
    {
        ...
        :src_added_open           => stats_open[:lines_added],
        :src_deleted_open         => stats_open[:lines_deleted],
        :src_churn_open           => stats_open[:lines_added] + stats_open[:lines_deleted],
        :test_added_open          => stats_open[:test_lines_added],
        :test_deleted_open        => stats_open[:test_lines_deleted],
        ...
        :src_added                => stats[:lines_added],
        :src_deleted              => stats[:lines_deleted],
        :src_churn                => stats[:lines_added] + stats[:lines_deleted],
        :test_added               => stats[:test_lines_added],
        :test_deleted             => stats[:test_lines_deleted],
